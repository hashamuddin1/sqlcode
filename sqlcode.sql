...
/*CREATE A VIEW*/
create view demoview as select * from student where cnic_no>1000;
...
insert into person1 values (5569,"o");
insert into person1 values (5570,"p");
insert into person1 values (556,"q");
insert into person1 values (557,"r");
insert into person1 values (500,"s");
insert into person1 values (470,"t");

/*JOIN 3 TABLE*/
select * from student
inner join person on student.cnic_no=5569 and person.id=5569
inner join person1 on student.cnic_no=5569 and person1.id=5569;
